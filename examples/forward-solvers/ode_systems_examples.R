...
# =============================================================================
# run_example -- canonical AdjointForwardSolver workflow
#
# Arguments
# ---------
...
#
# Returns the fitted AdjointForwardSolver object invisibly.
# =============================================================================
run_example <- function(cfg,
  ...
  # 2. Solver
  cat("\n=== AdjointForwardSolver  lambda =", lambda, "===\n")
...
run_missing_data_example <- function(lambda = 1) {
  cat("\n=== AdjointForwardSolver: missing-data (Lotka-Volterra) ===\n")
...
run_discovery_example <- function(lambda = 0.01) {
  cat("\n=== AdjointForwardSolver: dynamics-discovery example ===\n")
...
run_sse_surface_example <- function() {
  cat("\n=== AdjointForwardSolver: SSE surface (Lotka-Volterra) ===\n")
